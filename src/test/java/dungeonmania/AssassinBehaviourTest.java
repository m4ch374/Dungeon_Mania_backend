...
public class AssassinBehaviourTest {
    ...
    @Test
    @DisplayName("Test Assassin does not flee")
    public void testMovement_doesNotFlee() {
        DungeonManiaController dmc = new DungeonManiaController();

        DungeonResponse res = dmc.newGame(DIR_PATH + "d_assassinTest_doesNotFlee", "c_msic_zeroDamage");
